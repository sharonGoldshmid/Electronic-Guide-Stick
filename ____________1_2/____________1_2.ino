//מחוברים שני חיישנים ללדים, הלדים נדלקים במרחק קטן. יש שתי פסיקות
//בעיה: טעויות טכניות בכתיבה. דרך חשיבה- תוכנית מהחוברת ששינינו להיות לשני חיישנים
...
void loop()
{
  if(millis()-time>500) {  //מדידת מרחק כל חצי שניה
 ...
 if (distance1<10 )                        // אם המרחק קטן מ 15 ס"מ
    digitalWrite(led1,HIGH);       // הדלק את הלד          
 else                                    // אחרת 
    digitalWrite(led1,LOW);
 if (distance2<10 )                        // אם המרחק קטן מ 15 ס"מ
    digitalWrite(led2,HIGH);       // הדלק את הלד          
 else                                    // אחרת 
